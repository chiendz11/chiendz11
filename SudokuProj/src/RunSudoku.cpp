...
//--------------------------------------Private methods----------------------------------------//
inline void Sudoku::Run::setElement(const int row, const int col, const int num)
{
	mGrid[row * 9 + col] = num;
}

inline int Sudoku::Run::getElement(const int row, const int col) const
{
	return mGrid[row * 9 + col];
}

void Sudoku::Run::swapNumbers(const int index1, const int index2)
{
...
void Sudoku::Run::swapRows(const int row1, const int row2)
{
...
void Sudoku::Run::swapCols(const int col1, const int col2)
{
...
void Sudoku::Run::swapRowBlocks(const int rowBlock1, const int rowBlock2)
{
...
void Sudoku::Run::swapColBlocks(const int colBlock1, const int colBlock2)
{
...
void Sudoku::Run::fillNextRow(const int previousRow, const int nextRow, const int shifts)
{
...
void Sudoku::Run::copyGrid(int* grid) const
{
	for (int i = 0; i < 81; i++)
	{
		grid[i] = mGrid[i];
...
void Sudoku::Run::createCompletedSudoku()
{
...
//--------------------------------------Public methods----------------------------------------//
void Sudoku::Run::generate(int* grid, int* solutionGrid,int toremove)
{
